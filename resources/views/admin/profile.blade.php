                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-sm-4 col-form-label"> Email adress</label>
                                            <div class="col-md-9 col-sm-8">
                    ...
                    <div class="modal-dialog modal-dialog-vertical modal-dialog-scrollable">
                        <div class="modal-content rounded-0">
                            ...
                            <div class="progress bg-transparent" style="height: 3px;">
                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="1"
                                    aria-valuemin="1" aria-valuemax="5" style="width: 20%;"></div>
                            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="step1">
                                                    ...
                                                    <label class="m-1 w-100" for="Personal">
                                                        ...
                                                        <span class="card">
                                                            <span class="card-body d-flex p-3">
                                                                ...
                                                                <span class="ms-3">
                                                                    <span class="h6 d-flex mb-1">Personal
                                                                        Project</span>
                                                                    <span class="text-muted">For smaller business,
                                                                        with simple salaries and pay schedules.</span>
                                                                </span>
                                                            </span>
                                                        </span>
                                                    </label>
                                                        ...
                                                        <span class="card">
                                                            <span class="card-body d-flex p-3">
                                                                ...
                                                                <span class="ms-3">
                                                                    ...
                                                                    <span class="text-muted">For growing business who
                                                                        wants to create a rewarding place to
                                                                        work.</span>
                                                                </span>
                                                            </span>
                                                        </span>
                                        ...
                                        <div class="card mb-2">
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted small">It is a long established fact that a
                                                    reader will be distracted by Luno.</p>
                                                    ...
                                                    <div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="allow_phone" value="option1">
                                                            <label class="form-check-label"
                                                                for="allow_phone">Phone</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input class="form-check-input" type="checkbox"
                                                                id="allow_email" value="option2">
                                                            <label class="form-check-label"
                                                                for="allow_email">Email</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0"
                                                ...
                                                <li class="list-group-item d-flex align-items-center">
                                                    <img class="avatar rounded"
                                                        src="src="{{ asset('storage/images/users/' . Auth::user()->image) }}
                                                        alt="">
                                                    <div class="flex-fill ms-2">
                                    ...
                                    <div class="tab-pane fade" id="step4">
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <span class="text-muted">If you need more info, please check how to
                                                    create project</span>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    <div class="tab-pane fade active show" id="Notetab-all" role="tabpanel">
                                        <div class="card ribbon mb-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <span>It has roots in a piece of classical Latin literature from 45 BC,
                                                    making it over 2020 years old.</span>
                                            </div>
                                        ...
                                        <div class="card ribbon mb-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <span>The generated Lorem Ipsum is therefore always free from
                                                    repetition</span>
                                            </div>
                                            <div class="card-footer pt-0 border-0">
                                                <a class="btn btn-sm btn-outline-secondary" href="#"><i
                                        ...
                                        <div class="card ribbon mb-2">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <span>Many desktop publishing packages and web page editors now use
                                                    Lorem Ipsum as their default model</span>
                                            </div>
                                            <div class="card-footer pt-0 border-0">
                                                <a class="btn btn-sm btn-outline-secondary" href="#"><i
                                                        class="fa fa-star favourite-note"></i></a>
                                            ...
                                            <div class="card-header border-bottom py-3">
                                                ...
                                                <div class="dropdown morphing scale-left">
                                                    ...
                                                    <ul class="dropdown-menu shadow border-0 p-2">
                                                        <li><a class="dropdown-item" href="#">File Info</a>
                                                        </li>
                                                ...
                                                <ul class="list-unstyled chat-history flex-grow-1">
                                                    ...
                                                    <li class="mb-3 d-flex flex-row-reverse align-items-end">
                                                        <div class="max-width-70 text-end">
                                                            ...
                                                            <div class="card border-0 p-3 bg-primary text-light">
                                                                <div class="message">Yes, Orlando Allredy done <br>
                                                    ...
                                                    <li class="mb-3 d-flex flex-row-reverse align-items-end">
                                                        <div class="max-width-70 text-end">
                                                            ...
                                                            <div class="card border-0 p-3 bg-primary text-light">
                                                                <div class="message">Okay, will check and let you
                                                                    know.</div>
                                                            </div>
                                                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="px-xl-4 modal-body custom_scroll">
                                ...
                                <div class="card fieldset border setting-font">
                                    ...
                                    <div class="c_radio d-flex text-center font_setting">
                                        ...
                                        <label class="m-1" for="font-nunito">
                                            <input type="radio" name="font" id="font-nunito"
                                ...
                                <div class="m-1 p-3 bg-body rounded-4 mb-4">
                                    ...
                                    <button id="font_apply" type="submit" class="btn btn-primary">Save
                                        Changes</button>
                                    ...
                                    <ul class="list-group list-group-flush list-group-custom fs-6">
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check form-switch pageheader-switch mb-1">
                                                <input class="form-check-input" type="checkbox" id="PageHeader"
                                                    checked>
                                                <label class="form-check-label" for="PageHeader">Page Header
                                                    Fix</label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check form-switch sidebar-v2 mb-1">
                                                ...
                                                <label class="form-check-label" for="sidebar_v2">Sidebar Version
                                                    2</label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check form-switch sidebardark-switch mb-1">
                                                ...
                                                <label class="form-check-label" for="SidebarDark">Enable Dark! (
                                                    Sidebar )</label>
                                            </div>
                                        </li>
                                            ...
                                            <div class="bg-images">
                                                <ul class="list-unstyled d-flex">
                                                    <li class="sidebar-img-1 me-1 sidebar-img-active"><a
                                                            class="rounded sidebar-img" id="img-1"
                                                            href="#"><img
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check form-switch fluid-switch mb-1">
                                                <input class="form-check-input" type="checkbox" id="fluidLayout"
                                                    checked="">
                                                <label class="form-check-label" for="fluidLayout">Container
                                                    Fluid</label>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item">
                                            <div class="form-check form-switch shadow-switch mb-1">
                                                ...
                                                <label class="form-check-label" for="card_shadow">Card
                                                    Box-Shadow</label>
                                            </div>
                                        </li>
                                    </ul>
