...
<head>
  ...
  @include('admin.includs.css')
</head>

<body class="layout-1 @if (app()->getLocale() == 'ar') rtl_mode @endif" data-luno="theme-blue">
      ...
      <div class="container-fluid">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-7 col-sm-12 mt-2 mt-md-0">
            ...
            <script src="{{url('/')}}/admin/assets/js/bundle/daterangepicker.bundle.js"></script>
          ...
          <div class="tab-content">
              ...
              <div class="card mb-3">
                ...
                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0" style="height: 300px;">
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar1.jpg" alt="">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar2.jpg" alt="">
                    <div class="flex-fill ms-2">
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar3.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar4.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar5.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar6.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar7.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
                  ...
                  <li class="list-group-item d-flex align-items-center">
                    <img class="avatar rounded" src="{{url('/')}}/admin/assets/img/xs/avatar8.jpg" alt="">
                    <div class="flex-fill ms-2">
                      <div class="h6 mb-0">Chris Fox</div>
            ...
            <div class="tab-pane fade" id="step4">
              <div class="card text-center">
                ...
                <div class="card-body">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/project-team.svg" alt="" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="ps-2">
            ...
            <div class="timeline-item ti-info p-3">
              <div class="timeline-icon">
                <img class="avatar sm rounded-circle" src="{{url('/')}}/admin/assets/img/xs/avatar1.jpg" alt="">
              </div>
              <div class="timeline-content ms-3">
        ...
        <div class="d-flex align-items-start">
          <div class="nav flex-column nav-pills p-3 h-100">
            <a class="nav-link rounded-circle p-1 mb-2 active" href="javascript:void(0);" data-bs-toggle="pill"
              ...
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar1.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar2.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar3.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-2" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar4.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-5" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar5.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar6.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-7" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar7.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar8.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-3" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar9.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar10.jpg" alt="avatar">
            </a>
            <a class="nav-link rounded-circle p-1 mb-2" href="javascript:void(0);" data-bs-toggle="pill"
              data-bs-target="#c-user-1" title="">
              <img class="avatar sm rounded-circle border" src="{{url('/')}}/admin/assets/img/xs/avatar5.jpg" alt="avatar">
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{url('/')}}/admin/assets/img/xs/avatar1.jpg" alt="avatar">
                    </a>
                    <div class="ms-3">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{url('/')}}/admin/assets/img/xs/avatar1.jpg" alt="avatar">
                      ...
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            ...
                            <img class="w120 img-thumbnail" src="{{url('/')}}/admin/assets/img/gallery/3.jpg" alt="">
                            <img class="w120 img-thumbnail" src="{{url('/')}}/admin/assets/img/gallery/4.jpg" alt="">
                          </div>
                        </div>
                      </div>
            ...
            <div class="tab-pane fade show active" id="c-user-2" role="tabpanel">
              <div class="card">
                ...
                <div class="card-header border-bottom py-3">
                  <div class="d-flex">
                    <a href="javascript:void(0);" title="">
                      <img class="avatar rounded-circle" src="{{url('/')}}/admin/assets/img/xs/avatar2.jpg" alt="avatar">
                    </a>
                    <div class="ms-3">
                      <h6 class="mb-0">Orlando Lentz</h6>
                      <small class="text-muted">Last seen: 2 hours ago</small>
                ...
                <div class="card-body custom_scroll" style="height: calc(100vh - 141px);">
                  <ul class="list-unstyled chat-history flex-grow-1">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        <div class="user-info mb-1">
                          <img class="avatar xs rounded-circle me-1" src="{{url('/')}}/admin/assets/img/xs/avatar2.jpg" alt="avatar">
                          <span class="text-muted small">10:10 AM, Today</span>
                        </div>
                        <div class="card p-3">
                          <div class="message"> Hi Aiden, how are you?</div>
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message">
                            <p>Please find attached images</p>
                            <img class="w120 img-thumbnail" src="{{url('/')}}/admin/assets/img/gallery/1.jpg" alt="">
                            <img class="w120 img-thumbnail" src="{{url('/')}}/admin/assets/img/gallery/2.jpg" alt="">
                          </div>
                        </div>
                      </div>
          ...
          <div class="card fieldset border setting-mode mb-4">
            ...
            <div class="c_radio d-flex text-center">
              <label class="m-1 theme-switch" for="theme-switch">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/dark-version.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-dark" for="theme-dark">
                <input type="checkbox" id="theme-dark" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/dark-theme.svg" alt="Theme Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                <input type="checkbox" id="theme-high-contrast" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/high-version.svg" alt="High Contrast" />
                </span>
              </label>
              <label class="m-1 theme-rtl" for="theme-rtl">
                <input type="checkbox" id="theme-rtl" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/rtl-version.svg" alt="RTL Mode!" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="card fieldset border setting-font">
            ...
            <div class="c_radio d-flex text-center font_setting">
              <label class="m-1" for="font-opensans">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/font-opensans.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-quicksand">
                <input type="radio" name="font" id="font-quicksand" value="font-quicksand" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/font-quicksand.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-nunito">
                <input type="radio" name="font" id="font-nunito" value="font-nunito" checked="" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/font-nunito.svg" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-raleway">
                <input type="radio" name="font" id="font-raleway" value="font-raleway" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{url('/')}}/admin/assets/img/font-raleway.svg" alt="Dark Mode" />
                </span>
              </label>
            </div>
          </div>
                ...
                <div class="bg-images">
                  <ul class="list-unstyled d-flex">
                    <li class="sidebar-img-1 me-1 sidebar-img-active"><a class="rounded sidebar-img" id="img-1"
                        href="#"><img src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-1.jpg" alt="" /></a></li>
                    <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img" id="img-2" href="#"><img
                          src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-2.jpg" alt="" /></a></li>
                    <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img" id="img-3" href="#"><img
                          src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-3.jpg" alt="" /></a></li>
                    <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img" id="img-4" href="#"><img
                          src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-4.jpg" alt="" /></a></li>
                    <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img" id="img-5" href="#"><img
                          src="{{url('/')}}/admin/assets/img/sidebar-bg/sidebar-5.jpg" alt="" /></a></li>
                  </ul>
                </div>
              </li>
